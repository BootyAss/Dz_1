...
void main() {
	...
	while (true) {
		...
		case 6:		//find
			...
			break;
		case 7:		// ???
			std::cout << "7, that's my Birthday ¯＼_(ツ)_/¯";
			break;
		case 8:		//delete
			while (arg == "") {
			...
			if (CURRENT == 0)
				if (arg == "all") {
					std::cout << "\n Are You sure? That will delete all DBs and their data. Can't be undone\n>";
					std::getline(std::cin, arg);
					...
					std::cout << "\n Are You sure? That will delete DB & its data. Can't be undone\n>";
				...
				if (arg == "all") {
					std::cout << "\n Are You sure? That will delete all Units and their data. Can't be undone\n>";
					std::getline(std::cin, arg);
					if (arg == "yes" || arg == "Yes" || arg == "y" || arg == "Y")
						current->clear();
				}
				else {
					std::cout << "\n Are You sure? That will delete Unit & its data. Can't be undone\n>";
					std::getline(std::cin, cmd);
					if (cmd == "yes" || cmd == "Yes" || cmd == "y" || cmd == "Y")
